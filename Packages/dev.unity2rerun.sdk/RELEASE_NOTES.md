...
This release is prepared for GitHub-to-Zenodo archival. After creating the GitHub release and waiting for Zenodo to archive it, update the repository README and `CITATION.cff` with the assigned Concept DOI or version-specific DOI as appropriate.
