...
// Purpose: Provides the Rerun Interactive 3D Publisher Unity sample script for users importing the package.
...
{
    /// <summary>
    /// Sample MonoBehaviour for Rerun Interactive 3D Publisher in Unity sample scene.
    /// </summary>
